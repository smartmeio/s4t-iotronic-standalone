...
board_utility = require('./mng_board');
    ...
    db.checkBoard(board_id, function (data) {
        ...
        if (data.result == "ERROR") {
            ...
            if (data.message.length == 0) {
                ...
                logger.warn("[SYSTEM] - A not registered board has tried connecting to Iotronic - board_id: '"+board_id+"'");
                ...
                // Verify is really connected
                board_utility.wampConnTest(board_id, function (check){
                    ...
                    if(check.result == "SUCCESS"){
                        ...
                        db.changeBoardWampStatus(board_id, 'null', 'D', function (data) {

                            if (data.result == "ERROR") {

                                response.message = "Board with UUID '"+board_id+"' was in wrong connection status...reset DB status failed!";
                                response.result = 'REJECTED';
                                ...
                                response.message = "Board with UUID '"+board_id+"' was in wrong connection status...DB status successfully reset!";
                                response.result = 'REJECTED';
