...
CREATE TABLE IF NOT EXISTS `s4t-iotronic`.`plugins` (
  ...
  `iotronic_dep` VARCHAR(45) NULL DEFAULT 'false',
  `packaging` VARCHAR(45) NULL DEFAULT 'single',
...
CREATE TABLE IF NOT EXISTS `s4t-iotronic`.`plugins_injected` (
  ...
  `autostart` VARCHAR(45) NULL DEFAULT 'false',
  `on_maintenance` VARCHAR(45) NULL DEFAULT 'false',
